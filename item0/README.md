...
Помимо модели в основном файле представлены так же функция train, которая и отвечает за обучение данной модели и evaluate, отвечающаяя за итоговую оценку обученной модели.
