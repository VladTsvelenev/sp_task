...
train_sizeD = int(len(train_dataD) * 0.8)
test_sizeD = len(train_dataD) - train_sizeD

train_dataD, test_dataD = torch.utils.data.random_split(train_dataD, [train_sizeD, test_sizeD])
